...
(function () {
    ...
    // ── Sidebar accordion + hamburger are now wired in layout.html inline script ──
    // (runs on every admin page, including pages that do not load this file)
...
// ── Team Forecast Modal + Provision Master Excel are now wired in layout.html ──
